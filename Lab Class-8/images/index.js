...
// Number to String
let s = b.toString();
document.writeln("Number to String = " + s + " (" + typeof(s) +
")<br>");
// String to Number
let y = "103.07";
let x = parseInt(y);
...
let f = parseFloat(y);
document.writeln("parseFloat(y) = " + f + " (" + typeof(f) +
")<br>");
// NaN check example
document.writeln("Number('ASDDDF') = " + Number("ASDDDF") + "<br>");
document.writeln("Number('124579.99') = " + Number("124579.99") +
"<br>");
// User Input
...
document.writeln("<tr><td>" + num1 + " + " + num2 + "</td><td>" +
sum + "</td></tr>");
document.writeln("<tr><td>" + num1 + " - " + num2 + "</td><td>" +
sub + "</td></tr>");
document.writeln("<tr><td>" + num1 + " * " + num2 + "</td><td>" +
